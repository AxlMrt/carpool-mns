...
namespace Carpool.Infrastructure.Migrations
{
    ...
    [Migration("20240107185234_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carpool.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Carpool.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Carpool.Domain.Entities.Message", b =>
                {
                    b.HasOne("Carpool.Domain.Entities.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Carpool.Domain.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Carpool.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Carpool.Domain.Entities.Feedback", "Feedback")
                        .WithMany()
                        .HasForeignKey("FeedbackId");

                    b.HasOne("Carpool.Domain.Entities.Message", "Message")
                        .WithMany()
